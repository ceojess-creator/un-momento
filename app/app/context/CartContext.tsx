...
export interface CartItem {
  ...
  dropQR:       boolean;
  vaultPrints:  any[];
  mediaFile:    null; // can't serialize File — store separately
  mediaType:    string | null;
  mediaUrl:     string | null; // blob URL for preview
...
// Serialize cart for localStorage (exclude File objects and blob URLs)
function serializeCart(items: CartItem[]): any[] {
  return items.map(item => ({
    ...item,
    mediaFile: null,
    mediaUrl:  null, // blob URLs don't survive refresh
    // Keep dataUrls in editorState/stickerData/buttonDesign/vaultPrints
  }));
}
