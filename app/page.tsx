  ...
  return (
    <main style={{
      ...
      <nav style={{
        ...
        <a href="/" style={{ fontSize: 13, fontWeight: 600, color: '#fff',
        ...
        <div style={{ display: 'flex', gap: 24, alignItems: 'center' }}
          ...
          {[
            ['/event/grad-2026', 'Order'],
            ['/events',          'Book an event'],
            ['/creator/signup',  'Become a creator'],
          ...
          <a href="/event/grad-2026" style={{
            padding: '7px 14px', background: '#4ADE80', color: '#000',
      ...
      {menuOpen && (
        <div style={{
          ...
          {[
            ['/event/grad-2026', '🖼️ Order prints'],
            ['/events',          '🎪 Book an event'],
            ['/creator/signup',  '🎓 Become a creator'],
            ['/leaderboard',     '🏆 Leaderboard'],
            ['/account',         '👤 My account'],
            ...
            <a key={href} href={href}
              ...
              style={{ fontSize: 14, color: '#ccc', textDecoration: 'none',
      ...
      <section style={{
        ...
        <p style={{ fontSize: 11, color: '#4ADE80', letterSpacing: 5,
                    textTransform: 'uppercase', margin: '0 0 20px', fontWeight: 500 }}>
          Un Momento Prints
        </p>
        <h1 style={{
          fontSize: 'clamp(32px, 7vw, 64px)', fontWeight: 500, lineHeight: 1.1,
          maxWidth: 720, margin: '0 0 24px', letterSpacing: '-0.02em',
        }}>
        ...
        <div style={{
          ...
          <a href="/events" style={{
            ...
            color: '#fff', borderRadius: 10, textDecoration: 'none', fontSize: 15,
          }}>Book an event →</a>
          <a href="/creator/signup" style={{
            padding: '14px 28px',
            border: '1px solid rgba(255,255,255,0.1)',
            color: '#888', borderRadius: 10, textDecoration: 'none', fontSize: 15,
          }}>Become a creator</a>
        </div>
      ...
      <section style={{ padding: '80px 24px', maxWidth: 800, margin: '0 auto' }}>
        ...
        <h2 style={{ fontSize: 'clamp(24px, 4vw, 36px)', fontWeight: 500,
                     textAlign: 'center', margin: '0 0 48px', letterSpacing: '-0.01em' }}>
          Three ways to be part of Un Momento
        </h2>

        {/* Journey 1 — Order online */}
        <div style={{ marginBottom: 48 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
            <div style={{ width: 32, height: 32, borderRadius: '50%',
                          background: '#4ADE80', color: '#000',
                          display: 'flex', alignItems: 'center', justifyContent: 'center',
                          fontSize: 14, fontWeight: 700, flexShrink: 0 }}>1</div>
          ...
          <div style={{ paddingLeft: 44 }}>
            ...
            <div style={{ display: 'grid',
              ...
              {[
                ...
                <div key={s.n} style={{ background: '#111', borderRadius: 10,
                  ...
                  <p style={{ fontSize: 10, color: '#555', margin: '0 0 6px', letterSpacing: 2 }}>{s.n}</p>
            ...
            <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              ...
              <a href="/events" style={{
                padding: '10px 20px', border: '1px solid #333', color: '#888',
        ...
        <div style={{ marginBottom: 48 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
            <div style={{ width: 32, height: 32, borderRadius: '50%',
                          background: '#4ADE80', color: '#000',
                          display: 'flex', alignItems: 'center', justifyContent: 'center',
                          fontSize: 14, fontWeight: 700, flexShrink: 0 }}>2</div>
            <h3 style={{ fontSize: 18, fontWeight: 500, margin: 0 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 12 }}>
                {[
                  ...
                  <div key={s.label} style={{ textAlign: 'center' }}>
                    <p style={{ fontSize: 22, fontWeight: 600, color: '#4ADE80', margin: '0 0 2px' }}>{s.value}</p>
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
            <div style={{ width: 32, height: 32, borderRadius: '50%',
                          background: '#4ADE80', color: '#000',
                          display: 'flex', alignItems: 'center', justifyContent: 'center',
                          fontSize: 14, fontWeight: 700, flexShrink: 0 }}>3</div>
            <h3 style={{ fontSize: 18, fontWeight: 500, margin: 0 }}>
          ...
          <div style={{ display: 'grid',
            ...
            {[
              ...
              <div key={s.year} style={{ background: '#111', borderRadius: 10,
                                         ...
                                         textAlign: 'left' }}>
                <p style={{ fontSize: 13, fontWeight: 600, color: '#4ADE80', margin: '0 0 6px' }}>{s.year}</p>
                <p style={{ fontSize: 12, color: '#666', margin: 0, lineHeight: 1.6 }}>{s.text}</p>
              </div>
            ))}
          </div>
          <a href="/event/grad-2026" style={{
      ...
      <section style={{ padding: '80px 24px', maxWidth: 600, margin: '0 auto' }}
        ...
        {searched && !searching && results.length===0 && (
          <div style={{ background: '#111', borderRadius: 10, padding: '20px',
                        textAlign: 'center', border: '1px solid #1a1a1a', marginBottom: 16 }}>
            ...
            }}>Order anyway → donation goes to general fund</a>
          </div>
        )}
        ...
        {results.length>0 && (
          <div>
            ...
            {results.map(c => (
              <a key={c.handle} href={`/${c.handle}`} style={{ textDecoration: 'none' }}>
                <div style={{
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <p style={{ fontWeight: 600, fontSize: 14, margin: '0 0 3px', color: '#fff',
                                display: 'flex', alignItems: 'center', gap: 6 }}>
                      {c.display_name}
                      {c.is_verified && (
                        <span style={{ fontSize: 10, background: '#4ADE80', color: '#000',
                                       padding: '1px 5px', borderRadius: 4, fontWeight: 700 }}>✓</span>
                      )}
                    </p>
                    <p style={{ fontSize: 12, color: '#888', margin: '0 0 2px',
                                overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {c.school_name}{c.graduation_year ? ` · Class of ${c.graduation_year}` : ''}
                    </p>
                  ...
                  <div style={{ textAlign: 'right', flexShrink: 0 }}>
                    ...
                    <p style={{ fontSize: 12, color: '#555', margin: 0 }}>Order through link →</p>
                  </div>
                </div>
              </a>
            ))}
        ...
        <div style={{ textAlign: 'center', marginTop: 20 }}>
          ...
          }}>Or order without a creator link →</a>
        </div>
      </section>
              ...
              <div key={b.name} style={{
                ...
                {b.popular && (
                  <span style={{ position: 'absolute', top: -10, left: 12,
                                 ...
                                 padding: '2px 8px', borderRadius: 10 }}>MOST POPULAR</span>
                )}
                <p style={{ fontSize: 22, fontWeight: 600,
                            color: b.popular ? '#4ADE80' : '#fff', margin: '0 0 6px' }}>{b.price}</p>
                <p style={{ fontSize: 13, fontWeight: 600, margin: '0 0 6px' }}>{b.name}</p>
                <p style={{ fontSize: 12, color: '#666', margin: '0 0 14px', lineHeight: 1.5 }}>{b.items}</p>
                <a href="/event/grad-2026" style={{
      ...
      {/* ── FOOTER ── */}
      <footer style={{ padding: '48px 24px', borderTop: '1px solid #1a1a1a', textAlign: 'center' }}>
        <p style={{ fontSize: 13, color: '#4ADE80', fontWeight: 600, margin: '0 0 16px' }}>
          Un Momento LLC
        </p>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16,
                      justifyContent: 'center', marginBottom: 20 }}>
          {[
            ['/event/grad-2026',   'Order prints'        ],
            ['/events',            'Book an event'        ],
            ['/creator/signup',    'Become a creator'     ],
            ['/leaderboard',       'Leaderboard'          ],
            ['/account',           'My account'           ],
            ['mailto:ceojess@unmomentoprints.com', 'Contact'],
          ].map(([href, label]) => (
            <a key={href} href={href} style={{ fontSize: 13, color: '#555',
                                               textDecoration: 'none' }}>
              {label}
            </a>
          ))}
